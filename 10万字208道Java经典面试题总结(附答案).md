...
[57、为什么我们调用 start() 方法时会执行 run() 方法，为什么我们不能直接调用 run() 方法？](#t57)
...
[123、Spring Bean 的作用域之间有什么区别？Spring容器中的bean可以分为5个范围：](#t123)
...
[156、Spring Boot比Spring多哪些注解](#t156)
...
[189、新生代垃圾回收器和老生代垃圾回收器都有哪些？有什么区别？](#t189)
...
![](https://img-blog.csdnimg.cn/20210801175715748.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2d1b3J1aV9qYXZh,size_16,color_FFFFFF,t_70)
...
![](https://img-blog.csdnimg.cn/20210801175804261.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2d1b3J1aV9qYXZh,size_16,color_FFFFFF,t_70)
...
![](https://img-blog.csdnimg.cn/20210801175909518.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2d1b3J1aV9qYXZh,size_16,color_FFFFFF,t_70)
...
1、[jsonp原理详解——终于搞清楚jsonp是啥了](https://blog.csdn.net/guorui_java/article/details/107345499 "jsonp原理详解——终于搞清楚jsonp是啥了")
...
![](https://img-blog.csdnimg.cn/20210801180652362.jpg)

大家看到了吧，由于引进了中间位置的“第三方”，也就是IOC容器，使得A、B、C、D这4个对象没有了耦合关系，齿轮之间的传动全部依靠“第三方”了，全部对象的控制权全部上缴给“第三方”IOC容器，所以，IOC容器成了整个系统的关键核心，它起到了一种类似“粘合剂”的作用，把系统中的所有对象粘合在一起发挥作用，如果没有这个“粘合剂”，对象与对象之间会彼此失去联系，这就是有人把IOC容器比喻成“粘合剂”的由来。  
我们再来做个试验：把上图中间的IOC容器拿掉，然后再来看看这套系统（拿掉IoC容器后的系统）：

![](https://img-blog.csdnimg.cn/20210801180714819.jpg)
...
![](https://img-blog.csdnimg.cn/20210801180744625.jpg)
...
```java
@Configurationpublic class DemoConfig {    @Bean    public User zs(){        return new User();    }    @Bean    public Dog dog(){        return  new Dog();    }    @Bean  //两个狗    public Dog haqi(){        return new Dog();    }}
```
...
[Spring常用注解（绝对经典）](https://blog.csdn.net/guorui_java/article/details/107347754 "Spring常用注解（绝对经典）")
...
![](https://img-blog.csdnimg.cn/20210801181255483.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2d1b3J1aV9qYXZh,size_16,color_FFFFFF,t_70)
...
![](https://img-blog.csdnimg.cn/20210801181330199.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2d1b3J1aV9qYXZh,size_16,color_FFFFFF,t_70)

![](https://img-blog.csdnimg.cn/20210801181401168.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2d1b3J1aV9qYXZh,size_16,color_FFFFFF,t_70)
...
![](https://img-blog.csdnimg.cn/20210801181428450.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2d1b3J1aV9qYXZh,size_16,color_FFFFFF,t_70)
...
![](https://img-blog.csdnimg.cn/20210801181510714.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2d1b3J1aV9qYXZh,size_16,color_FFFFFF,t_70)
...
```XML
spring.jpa.properties.hibernate.show_sql=truespring.jpa.properties.hibernate.format_sql=truespring.jpa.properties.hibernate.use_sql_comments=true
```
...
[Spring Boot常用注解（绝对经典）](https://blog.csdn.net/guorui_java/article/details/107379648 "Spring Boot常用注解（绝对经典）")
...
![](https://img-blog.csdnimg.cn/20210801183934528.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2d1b3J1aV9qYXZh,size_16,color_FFFFFF,t_70)
...
[说一下 jvm 有哪些垃圾回收器？](https://blog.csdn.net/guorui_java/article/details/108405844 "说一下 jvm 有哪些垃圾回收器？")
...
![](https://img-blog.csdnimg.cn/7a795a91f31b4360a55a6c2439b20141.gif)

![](https://img-blog.csdnimg.cn/2f3d245fb4f14fae8a423d0c159becfe.png)
...
本文转自 <https://blog.csdn.net/guorui_java/article/details/119299329>，如有侵权，请联系删除。